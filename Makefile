...
publish:
	...
	python googlecode_upload.py -s ctouch_standard -p ctouch -u cielartisan -w $(shell ruby getpass.rb) ctouch_standard_r$(shell hg log -l1 --template '{rev}').crx
	python googlecode_upload.py -s ctouch_fixed -p ctouch -u cielartisan -w $(shell ruby getpass.rb) ctouch_fixed_r$(shell hg log -l1 --template '{rev}').crx
	python googlecode_upload.py -s ctouch_external -p ctouch -u cielartisan -w $(shell ruby getpass.rb) ctouch_external_r$(shell hg log -l1 --template '{rev}').crx
