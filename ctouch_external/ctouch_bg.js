...
/// JSON START ///
	{
		"UA": [
			...
			["Galaxy Nexus (IceCreamSandwich/4.0)",
			...
			["Galaxy Nexus (IceCreamSandwich/4.0 Chrome)",
			...
			["Xoom (JellyBean/4.1 Chrome)",
				"Mozilla/5.0 (Linux; Android 4.1.2; Xoom Build/JZO54K) AppleWebKit/535.19 (KHTML like Gecko) Chrome/18.0.1025.166 Safari/535.19"],
			["iPhone (iOS 3.1.3)",
