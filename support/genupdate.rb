...
['ctouch_standard','ctouch_fixed','ctouch_external','ctouch_browserua','ctouch_filesystem'].each{|e|
	puts "<app appid='#{pkey_to_id(e)}'><updatecheck codebase='http://master.dl.sourceforge.net/project/ctouch/#{V}/#{e}.crx' version='#{V}'/></app>"
}
...
http://master.dl.sourceforge.net/project/ctouch/#{V}/#{e}.crx
